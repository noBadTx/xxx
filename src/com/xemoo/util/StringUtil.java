...
public abstract class StringUtil
{
    ...
    /**
     * 
     * @Title: splitByWhitSpace
     * @Description: 按照空白字符（空格、制表符、回车、换行）将字符串分隔并返回数组
     * @param str
     *            源字符串
     * @return String[] 按照空白字符分隔后的字符串数组
     */
    public static final String[] splitByWhitSpace(String str)
    {
     ...
     * 
     * @Title: splice
     * @Description: 将整数数组使用指定的分隔符拼接成字符串。
     * @param arr
     *            整数数组
     * @param sp
     *            分隔符
     ...
     */
    public static final String splice(int[] arr, char sp)
    {
    ...
    public static final String emptyIfNull(String input)
    {
     ...
     */
    public static final String truncate(String input, int len)
    {
     ...
     * 
     * @Title: lenInRange
     * @Description: 判断入参字符串的长度是否在[min, max]区间范围内。
     * @param input
     *            待判断的入参字符串
     * @param min
     *            区间下限
     ...
     */
    public static final boolean lenInRange(String input, int min, int max)
    {
        if (input == null)
        {
            return false;
    ...
    public static String subStringHTML(String param, int length, String end)
    {
        ...
        for (int i = 0; i < param.length(); i++)
        {
            ...
            {
                /**
                 * n = n + 1; // UNICODE码字符占两个字节 if ((temp +
                 * "").getBytes().length > 1) { n = n + 1; }
                 */
